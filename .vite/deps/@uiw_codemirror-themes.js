import "./dist-STzBzKwr.js";
import { o as EditorView } from "./dist-DWiRyRcq.js";
import { t as HighlightStyle, w as syntaxHighlighting } from "./dist-Jo2mh-hO.js";
//#region main-frontend-code/node_modules/@uiw/codemirror-themes/esm/index.js
var createTheme = (_ref) => {
	...
	return [EditorView.theme(themeOptions, { dark: theme === "dark" }), syntaxHighlighting(HighlightStyle.define(styles))];
};
//#endregion
