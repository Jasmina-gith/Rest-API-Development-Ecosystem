import { c as tags$1, m as NodeWeakMap, o as styleTags, u as IterMode, v as parseMixed } from "./dist-STzBzKwr.js";
import { i as LocalTokenGroup, n as ExternalTokenizer, r as LRParser, t as ContextTracker } from "./dist-6B1w95Bj.js";
import { et as EditorSelection, o as EditorView } from "./dist-DWiRyRcq.js";
import { C as sublanguageProp, T as syntaxTree, d as flatIndent, h as foldNodeProp, i as LanguageSupport, l as defineLanguageFacet, o as bracketMatchingHandle, p as foldInside, r as LRLanguage, s as continuedIndent, u as delimitedIndent, v as indentNodeProp } from "./dist-Jo2mh-hO.js";
import { i as completeFromList, o as ifNotIn, s as snippetCompletion } from "./dist-CFEsG8eD.js";
//#region main-frontend-code/node_modules/@lezer/html/dist/index.js
...
var lessThan = 60, greaterThan = 62, slash$1 = 47, question$1 = 63, bang = 33, dash$1 = 45;
...
function maybeNest(node, input, tags) {
	let attrs;
	for (let tag of tags) if (!tag.attrs || tag.attrs(attrs || (attrs = getAttrs(node.node.parent.firstChild, input)))) return { parser: tag.parser };
	return null;
}
...
//#endregion
//#region main-frontend-code/node_modules/@lezer/css/dist/index.js
var descendantOp = 100, Unit = 1, callee = 101, identifier$2 = 102, VariableName = 2;
var space$1 = [
	9,
	10,
	11,
...
var colon = 58, parenL = 40, underscore = 95, bracketL$1 = 91, dash = 45, period = 46, hash = 35, percent = 37, ampersand = 38, backslash = 92, newline$1 = 10;
function isAlpha(ch) {
...
var descendant = new ExternalTokenizer((input) => {
	if (space$1.includes(input.peek(-1))) {
		let { next } = input;
		if (isAlpha(next) || next == underscore || next == hash || next == period || next == bracketL$1 || next == colon && isAlpha(input.peek(1)) || next == dash || next == ampersand) input.acceptToken(descendantOp);
	}
});
...
var parser$1 = LRParser.deserialize({
	...
	tokenizers: [
		...
		3,
		4,
		new LocalTokenGroup("m~RRYZ[z{a~~g~aO#_~~dP!P!Qg~lO#`~~", 28, 106)
	],
	topRules: {
		"StyleSheet": [0, 4],
		"Styles": [1, 87]
...
//#endregion
//#region main-frontend-code/node_modules/@codemirror/lang-css/dist/index.js
...
var cssLanguage = /* @__PURE__ */ LRLanguage.define({
	name: "css",
	parser: /* @__PURE__ */ parser$1.configure({ props: [/* @__PURE__ */ indentNodeProp.add({ Declaration: /* @__PURE__ */ continuedIndent() }), /* @__PURE__ */ foldNodeProp.add({ "Block KeyframeList": foldInside })] }),
	languageData: {
		commentTokens: { block: {
			open: "/*",
			close: "*/"
...
//#endregion
//#region main-frontend-code/node_modules/@lezer/javascript/dist/index.js
var noSemi = 314, noSemiType = 315, incdec = 1, incdecPrefix = 2, questionDot = 3, JSXStartTag = 4, insertSemi = 316, spaces = 318, newline = 319, LineComment = 5, BlockComment = 6, Dialect_jsx = 0;
var space = [
	9,
	10,
	11,
...
var parser = LRParser.deserialize({
	...
	tokenizers: [
		...
		14,
		insertSemicolon,
		new LocalTokenGroup("$S~RRtu[#O#Pg#S#T#|~_P#o#pb~gOv~~jVO#i!P#i#j!U#j#l!P#l#m!q#m;'S!P;'S;=`#v<%lO!P~!UO!S~~!XS!Q![!e!c!i!e#T#Z!e#o#p#Z~!hR!Q![!q!c!i!q#T#Z!q~!tR!Q![!}!c!i!}#T#Z!}~#QR!Q![!P!c!i!P#T#Z!P~#^R!Q![#g!c!i#g#T#Z#g~#jS!Q![#g!c!i#g#T#Z#g#q#r!P~#yP;=`<%l!P~$RO(a~~", 141, 338),
		new LocalTokenGroup("j~RQYZXz{^~^O(O~~aP!P!Qd~iO(P~~", 25, 321)
	],
	topRules: {
		"Script": [0, 7],
...
//#endregion
//#region main-frontend-code/node_modules/@codemirror/lang-javascript/dist/index.js
/**
...
var autoCloseTags$1 = /* @__PURE__ */ EditorView.inputHandler.of((view, from, to, text, defaultInsert) => {
	...
	let closeTags = state.changeByRange((range) => {
		...
		if (state.doc.sliceString(head - 1, head) != text || around.name == "JSXAttributeValue" && around.to > head);
			...
			if (base && empty.from == head - 2 && ((name = elementName$1(state.doc, base.firstChild, head)) || ((_a = base.firstChild) === null || _a === void 0 ? void 0 : _a.name) == "JSXFragmentTag")) {
				let insert = `${name}>`;
				return {
...
//#endregion
//#region main-frontend-code/node_modules/@codemirror/lang-html/dist/index.js
var Targets = [
	"_blank",
	"_self",
	"_top",
...
var htmlPlain = /* @__PURE__ */ LRLanguage.define({
	name: "html",
	parser: /* @__PURE__ */ parser$2.configure({ props: [
