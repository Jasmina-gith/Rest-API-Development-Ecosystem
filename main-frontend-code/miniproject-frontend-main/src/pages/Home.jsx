...
import { generateId, getCurrentProject, getLastActiveProject, parseJson, parseKeyValPairs, updateState } from "../utils/utils";
...
function Home() {
	...
	function newTab() {
		updateState(({ tabs }) => {
			...
			const welcomeUrl = `https://echo.uib.no`
	...
	function saveProject() {
		...
		updateProject(currentProjectId, tabs).then(() => {
